...
ALIGNED_HEAD static uint8_t g_usbd_configuration[USBD_KEYBOARD_CONFIG_DESC_SIZE] ALIGNED_TAIL =
{
  ...
  0x02,//0x01,                                  /* bNumInterfaces: 2 interface */
...
/*18*/
  ...
  0x21,                                  /* ####bCountryCode: hardware target conutry */
...
/*34*/
  ...
  0x00,                                  /* bInterfaceSubClass: subclass code */
  0x00,                                  /* bInterfaceProtocol: protocol code */
  0x00,//1,                                 /* iInterface: index of string descriptor */
/*43*/
  0x09,                                  /* bLength: size of HID descriptor in bytes */
  HID_CLASS_DESC_HID,                    /* bDescriptorType: HID descriptor type */
  LBYTE(KEYBOARD_BCD_NUM),
...
/*34*/
  ...
  0x00,                                  /* bInterfaceSubClass: subclass code */
  0x00,                                  /* bInterfaceProtocol: protocol code */
  0x00,//0x00,                                  /* iInterface: index of string descriptor */
/*43*/
  0x09,                                  /* bLength: size of HID descriptor in bytes */
  HID_CLASS_DESC_HID,                    /* bDescriptorType: HID descriptor type */
  LBYTE(KEYBOARD_BCD_NUM),
...
ALIGNED_HEAD uint8_t g_usbd_keyboard_report[USBD_KEYBOARD_SIZ_REPORT_DESC] ALIGNED_TAIL =
{
  ...
  0x95, 0x68, // REPORT_COUNT (104)//一定要8的整数倍！！！
  0x75, 0x01, // REPORT_SIZE (1)
  0x15, 0x00, // LOGICAL_MINIMUM (0)
  0x25, 0x01, // LOGICAL_MAXIMUM (1)
  0x05, 0x07, // USAGE_PAGE (Keyboard)
  0x19, 0x04, // USAGE_MINIMUM (Keyboard a and A)
  0x29, 0x6b, // USAGE_MAXIMUM (Keyboard Application)
  0x81, 0x02, // INPUT (Data,Var,Abs)	
  0xc0,        // END_COLLECTION
	/**65**/
	/**0**/
